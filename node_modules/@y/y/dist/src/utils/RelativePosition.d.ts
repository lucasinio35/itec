...
export class AbsolutePosition {
     ...
     * @param {number} [assoc]
     */
    constructor(type: YType<any>, index: number, assoc?: number);
    /**
     * @type {YType<any>}
     */
    type: YType<any>;
...
export function createRelativePositionFromTypeIndex(type: YType, index: number, assoc?: number, attributionManager?: import("../utils/AttributionManager.js").AbstractAttributionManager): RelativePosition;
